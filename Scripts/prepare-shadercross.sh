...
if [ "$#" -ne 1 ]; then
    echo "usage: $0 <shadercross-artifact-directory>" >&2
    exit 1
fi

input_dir=$1
repository_root=$(CDPATH= cd -- "$(dirname -- "$0")/.." && pwd)
tag=shadercross-3.0.0-e55cf5e-silex.3
...
linux_arm64_input=$input_dir/Shadercross-3.0.0-e55cf5e-linux-arm64.tar.gz
...
linux_arm64_asset=$output_dir/Shadercross-3.0.0-e55cf5e-linux-arm64.tar.gz
...
verify 0b1fab54e52b22f055831b7e6e5e613e1fb21c0cc38d20057d9dd065b442cfbb "$linux_arm64_input"
...
cp "$linux_arm64_input" "$linux_arm64_asset"
...
verify 0b1fab54e52b22f055831b7e6e5e613e1fb21c0cc38d20057d9dd065b442cfbb "$linux_arm64_asset"
...
require_tar_entry "$linux_arm64_asset" "SDL3_shadercross-3.0.0-linux-arm64/share/licenses/SDL3_shadercross/LICENSE.txt"
require_tar_entry "$linux_arm64_asset" "SDL3_shadercross-3.0.0-linux-arm64/share/licenses/vkd3d/COPYING"
...

{
    ...
    echo "0b1fab54e52b22f055831b7e6e5e613e1fb21c0cc38d20057d9dd065b442cfbb  $(basename "$linux_arm64_asset")"
